...
namespace ImageChoose.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult GetPicture()
        {
            ...
            //{
            //    ImageName = imageName,
            //    ImageArray = string.Format("data:image/png;base64,{0}", Convert.ToBase64String(System.IO.File.ReadAllBytes(Server.MapPath("~/Images/" + imageName))))
            //};
            //userImageService.GetImageViewModel();
